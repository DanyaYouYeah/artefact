...
<tr>
    ...
    @endforeach
    <td class="danger">
        <button type="button" class="close form-control btn-remove-bread-relationship" aria-label="Закрыть"><span aria-hidden="true" class="glyphicon glyphicon-remove"></span></button>
    </td>
</tr>
</tr>
</script>