...
Чтобы просматривать аналитику, вам необходимо подключить google analytics, и изменить <code>google_analytics_client_id</code>. Получите свой ключ в консоли разработчика Google:
