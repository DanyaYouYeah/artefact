...
@section('page_header')
    <h1 class="page-title">
        <i class="{{ $dataType->icon }}"></i> @if(isset($dataTypeContent->id)){{ 'Редактирование' }}@else{{ 'Создание' }}@endif {{ $dataType->display_name_singular }}
    </h1>
@stop
            ...
            <div class="col-md-12">
                ...
                <div class="panel panel-bordered">
                    ...
                    <div class="panel-heading">
                        <h3 class="panel-title">@if(isset($dataTypeContent->id)){{ 'Редактирование' }}@else{{ 'Создание' }}@endif {{ $dataType->display_name_singular }}</h3>
                    </div>
                    <!-- /.box-header -->
                    <!-- form start -->
                        ...
                        <div class="panel-body">
                            ...
                            <div class="form-group">
                                ...
                                @if(isset($dataTypeContent->password))
                                    <br>
                                    <small>Оставьте пустым для сохранения старого</small>
                                @endif
                            ...
                            <div class="form-group">
                                <label for="role">Пользовательская группа</label>
